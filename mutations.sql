...
A: Represent the new requirement on the Entity Relationship Diagram (ERD) of the database, and have an attribute that is both unique and required.
   Insert the requirements into the required columns.
